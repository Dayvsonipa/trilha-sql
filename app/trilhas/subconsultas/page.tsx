      ...
      <div className="lesson-layout">
        ...
        <div className="lesson-content">
          ...
          <section className="lesson-section" id="listas">
            ...
            <div className="list-subquery"><article><small>SUBCONSULTA</small><h3>Clientes com pedido PAGO</h3><div><span>1</span><span>3</span><span>7</span><span>9</span></div></article><i>entra em</i><article><small>CONSULTA EXTERNA</small><h3>Cadastro completo</h3><p><code>id_cliente IN (1, 3, 7, 9)</code></p></article></div>
