      ...
      <div className="lesson-layout">
        ...
        <div className="lesson-content">
          ...
          <section className="lesson-section" id="textos">
            ...
            <div className="text-transform"><article><small>UPPER</small><span>Ana Souza</span><i>→</i><b>ANA SOUZA</b></article><article><small>LOWER</small><span>PIX</span><i>→</i><b>pix</b></article><article><small>CHAR_LENGTH</small><span>Ipatinga</span><i>→</i><b>8</b></article></div>
            <div className="concat-machine"><div><span>Ana Souza</span><small>nome</small></div><i>+</i><div><span> • </span><small>separador</small></div><i>+</i><div><span>Ipatinga</span><small>cidade</small></div><b>ANA SOUZA • Ipatinga</b></div>
          ...
          <section className="lesson-section" id="erros"><span className="lesson-label error-label">LABORATÓRIO DE ERROS</span><h2>O resultado denuncia a regra quebrada.</h2><div className="analysis-errors"><details><summary><code>SELECT id_categoria, nome, AVG(preco) ... GROUP BY id_categoria</code></summary><p><code>nome</code> não pertence ao agrupamento nem está dentro de uma função agregadora. Um grupo possui vários nomes: qual deles deveria aparecer?</p></details><details><summary><code>WHERE COUNT(*) &gt; 2</code></summary><p><code>WHERE</code> acontece antes da contagem existir. Para filtrar o resultado de uma agregação, use <code>HAVING</code>.</p></details><details><summary><code>AVG(preco) = 1279.266666...</code></summary><p>A média pode produzir muitas casas decimais. Use <code>ROUND(AVG(preco), 2)</code> quando o relatório exigir duas casas.</p></details></div></section>
