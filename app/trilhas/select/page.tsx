      ...
      <div className="lesson-layout">
        ...
        <div className="lesson-content">
          ...
          <section className="lesson-section" id="apresentacao">
            ...
            <div className="distinct-demo"><div><small>SEM DISTINCT</small><span>Sao Paulo</span><span>Campinas</span><span>Santos</span><span>Sao Paulo</span></div><i>→</i><div className="clean-list"><small>COM DISTINCT</small><span>Sao Paulo</span><span>Campinas</span><span>Santos</span></div></div>
          ...
          <section className="lesson-section" id="limite">
            ...
            <div className="limit-visual"><div className="limit-stack"><span>1 • Notebook Legion Pro</span><span>2 • Console PlayStation 5</span><span>3 • Monitor Odyssey G5</span><span className="cut-row">4 • Teclado Redragon Kumara</span><span className="cut-row">5 • Headset Cloud Stinger</span></div><div className="limit-gate"><b>LIMIT 3</b><span>Somente três linhas atravessam</span></div></div>
